...
{
    public partial class Customer_Bank_Payment : Form
    {
        ...
        public Customer_Bank_Payment(string customer_email, string location, string packageId, DateTime journeyDate, int numPersons, float total_amount)
        {
            InitializeComponent();
        ...
        {
            if (radioButton1.Checked) return "Bank Asia";
            if (radioButton2.Checked) return "UCB";
            if (radioButton6.Checked) return "BRAC";
            if (radioButton5.Checked) return "NRBC";
            if (radioButton3.Checked) return "DHAKA BANK";
            if (radioButton4.Checked) return "SONALI BANK";
            return null;
        }
