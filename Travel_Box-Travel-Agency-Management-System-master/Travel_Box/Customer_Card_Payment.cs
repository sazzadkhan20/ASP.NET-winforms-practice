...
{
    public partial class Customer_Card_Payment : Form
    {
        ...
        public Customer_Card_Payment(string customer_email, string location, string packageId, DateTime journeyDate, int numPersons, float total_amount)
        {
            InitializeComponent();
        ...
        {
            if (radioButton1.Checked) return "Visa Card";
            if (radioButton2.Checked) return "Master Card";
            return null;
        }
